...
public class Bicicleta {
    ...
    public static String rutaCorta2(int [] camino1, int [] camino2, int [] camino3) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El camino más corto es:"+Bicicleta.rutaCorta2(camino1,camino2,camino3)+".");
    }
}
